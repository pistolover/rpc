...
public class ClassLoaderUtils {
    ...
    public static URL getResource(String resourceName, Class callingClass) {
        ...
        return url != null || resourceName == null || resourceName.length() != 0 && resourceName.charAt(0) == 47 ? url
    ...
    public static Set<Class<?>> getClassesFromDirectory(File directory, String packageName)
    ...
    public static Set<Class<?>> getClassesFromJARFile(JarFile jarFile, String packageName) throws IOException,
