...
import server.FileItem;
import server.PostFormDataDecoder;
import server.Request;
import server.WebException;
...
public class RequestImp implements Request {
    ...
    private static final Logger log = Logger.getLogger(RequestImp.class);
    ...
    public String toString() {
        ...
        sb.append("[request] ").append(getMethod()).append(" ").append(getUri()).append(" ").append(getRemoteAddr())
                .append(":").append(getRemotePort());
